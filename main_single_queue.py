...
def alg_learning_single_simu(num_customer, num_server, E,
    ...
    while t < T:
        ...
        if M_temp > 0:
            assert (inv_demand_curve(arr_c_array_plus[0]) <= price_c_u_plus[0] and inv_demand_curve(
                arr_c_array_plus[0]) >= price_c_l_plus[0]) or (
                               abs((price_c_u_plus[0] + price_c_l_plus[0]) / 2 - inv_demand_curve(arr_c_array_plus[0])) <= 4 * epsilon), "too small ecs"

            assert (inv_supply_curve(arr_s_array_plus[0]) <= price_s_u_plus[0] and inv_supply_curve(
                arr_s_array_plus[0]) >= price_s_l_plus[0]) or (
                           abs((price_s_u_plus[0] + price_s_l_plus[0]) / 2 - inv_supply_curve(arr_s_array_plus[0])) <= 4 * epsilon), "too small ecs"
        ...
        if M_temp > 0:
            assert (inv_demand_curve(arr_c_array_minus[0]) <= price_c_u_minus[0] and inv_demand_curve(
                arr_c_array_minus[0]) >= price_c_l_minus[0]) or (
                           abs((price_c_u_minus[0] + price_c_l_minus[0]) / 2 - inv_demand_curve(arr_c_array_minus[0])) <= 4 * epsilon), "too small ecs"

            assert (inv_supply_curve(arr_s_array_minus[0]) <= price_s_u_minus[0] and inv_supply_curve(
                arr_s_array_minus[0]) >= price_s_l_minus[0]) or (
                           abs((price_s_u_minus[0] + price_s_l_minus[0]) / 2 - inv_supply_curve(arr_s_array_minus[0])) <= 4 * epsilon), "too small ecs"
